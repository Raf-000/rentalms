...
<body>
    ...
    <div class="contact-bar">
        ...
        <div class="contact-item">
            ...
            <span>486-Alley Street, Barangay 590, Sampaloc, Manila, Philippines</span>
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-column">
                ...
                <a href="{{ route('book-viewing') }}" class="footer-link">Book a Viewing</a>
                <a href="{{ route('login') }}" class="footer-link">Resident Log In</a>
            </div>

            <div class="footer-column">
                <h3 class="footer-title">CONTACT US</h3>
                <p class="footer-text">Phone: 0935 141 9936</p>
                <p class="footer-text">Addresss: <br>4486-Alley Street, Barangay 590, Sampaloc, Manila, Philippines</p>
                <!--p class="footer-text">Email: hello@gmail.com</p-->
            </div>

            <div class="footer-column">
                <h3 class="footer-title">VIEWING HOURS</h3>
                <p class="footer-text">Monday to Saturday</p>
                <p class="footer-text">09:00 AM to 5:00 PM</p>
            </div>
        </div>
